...
# the GIT_FOUND, GIT_EXECUTABLE and VERSION_FROM_GIT variables.
...
if (GIT_FOUND AND VERSION_FROM_GIT AND FALSE)
    ...
    message("Using the information from git")

else()

    # Git not available, assume this is a developer build and assign arbitrary version
    set(${PROJECT_NAME}_VERSION_STRING_FULL "0.0.0-devel")
    set(${PROJECT_NAME}_VERSION_STRING "0.0.0")
    set(${PROJECT_NAME}_VERSION_TWEAK "")
    set(${PROJECT_NAME}_VERSION_AHEAD "")
    set(${PROJECT_NAME}_VERSION_GIT_SHA "")
    set(${PROJECT_NAME}_VERSION_MAJOR 0)
    set(${PROJECT_NAME}_VERSION_MINOR 0)
    set(${PROJECT_NAME}_VERSION_PATCH 0)

    message("Using the default devel version")
